...
## Accuracy based only on large families
...
The results above are a bit ambiguous, but there is a trend wherei _most_ trait, but not FYLD :( , seem more accurately predicted based on larger families. 
