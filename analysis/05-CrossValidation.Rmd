...
# [1] "Done predicting fam vars. Took 79.19 mins for 216 crosses"
# [1] "Done predicting fam vars. Took 22.29 mins for 216 crosses"
# [1] "Done predicting fam vars. Took 58.34 mins for 156 crosses"
# [1] "Done predicting fam vars. Took 16.5 mins for 156 crosses"
# [1] "Done predicting fam vars. Took 79.49 mins for 210 crosses"
# [1] "Done predicting fam vars. Took 22.2 mins for 210 crosses"
# [1] "Done predicting fam vars. Took 66.44 mins for 171 crosses"
# [1] "Done predicting fam vars. Took 18.24 mins for 171 crosses"
# [1] "Done predicting fam vars. Took 61.67 mins for 163 crosses"
# [1] "Done predicting fam vars. Took 17.76 mins for 163 crosses"
# [1] "Done predicting fam vars. Took 95.71 mins for 253 crosses"
# [1] "Done predicting fam vars. Took 25.39 mins for 253 crosses"
# [1] "Done predicting fam vars. Took 72.98 mins for 190 crosses"
# [1] "Done predicting fam vars. Took 20.73 mins for 190 crosses"
# [1] "Done predicting fam vars. Took 59.18 mins for 161 crosses"
# [1] "Done predicting fam vars. Took 17.71 mins for 161 crosses"
# [1] "Done predicting fam vars. Took 72.42 mins for 189 crosses"
# [1] "Done predicting fam vars. Took 19.7 mins for 189 crosses"

# ~ 100 minutes per rep-fold, and perhaps 16 more sets to go = 26 more hours? 
...
# [1] "Done predicting fam vars. Took 33.82 mins for 156 crosses"
# [1] "Done predicting fam vars. Took 46.33 mins for 210 crosses"
# [1] "Done predicting fam vars. Took 37.9 mins for 171 crosses"
# [1] "Done predicting fam vars. Took 36.72 mins for 163 crosses"
# [1] "Done predicting fam vars. Took 54.57 mins for 253 crosses"
# [1] "Done predicting fam vars. Took 42.08 mins for 190 crosses"
# [1] "Done predicting fam vars. Took 35.8 mins for 161 crosses"
# [1] "Done predicting fam vars. Took 42.23 mins for 189 crosses"
# [1] "Done predicting fam vars. Took 47.4 mins for 205 crosses"
# [1] "Done predicting fam vars. Took 46.31 mins for 213 crosses"
# [1] "Done predicting fam vars. Took 39.56 mins for 180 crosses"
# [1] "Done predicting fam vars. Took 42.23 mins for 199 crosses"
# [1] "Done predicting fam vars. Took 42.68 mins for 183 crosses"
# [1] "Done predicting fam vars. Took 46.01 mins for 205 crosses"
# [1] "Done predicting fam vars. Took 41.98 mins for 185 crosses"
# [1] "Done predicting fam vars. Took 45.33 mins for 203 crosses"
# [1] "Done predicting fam vars. Took 42.25 mins for 186 crosses"
# [1] "Done predicting fam vars. Took 40.96 mins for 184 crosses"
# [1] "Done predicting fam vars. Took 46.43 mins for 207 crosses"
# [1] "Done predicting fam vars. Took 44.97 mins for 201 crosses"
# [1] "Done predicting fam vars. Took 42.35 mins for 199 crosses"
# [1] "Done predicting fam vars. Took 37.91 mins for 170 crosses"
# .....
# [1] "Saving outputs to disk."
# [1] "Accuracies predicted. Took  19.68694 hrs total.\n Goodbye!"

#  cvAD_5rep5fold
# $meanPredAccuracy
# # A tibble: 41,682 x 10
#    Repeat  Fold  modelType predOf Trait    BCHROMO BRLVLS BRNHT1 predVSobs      
#    <chr>   <chr> <chr>     <chr>  <chr>      <dbl>  <dbl>  <dbl> <list>         
#  1 Repeat1 Fold1 AD        MeanBV SELIND     -4.97 -0.459 -0.661 <tibble [1 × 5…
#  2 Repeat1 Fold1 AD        MeanBV BCHROMO    NA    NA     NA     <tibble [198 ×…
#  3 Repeat1 Fold1 AD        MeanBV BRLVLS     NA    NA     NA     <tibble [198 ×…
#  4 Repeat1 Fold1 AD        MeanBV BRNHT1     NA    NA     NA     <tibble [198 ×…
#  5 Repeat1 Fold1 AD        MeanBV DM         -4.97 -0.459 -0.661 <tibble [1 × 5…
#  6 Repeat1 Fold1 AD        MeanBV HI         -4.97 -0.459 -0.661 <tibble [1 × 5…
#  7 Repeat1 Fold1 AD        MeanBV logDYLD    -4.97 -0.459 -0.661 <tibble [1 × 5…
#  8 Repeat1 Fold1 AD        MeanBV logFYLD    -4.97 -0.459 -0.661 <tibble [1 × 5…
#  9 Repeat1 Fold1 AD        MeanBV logRTNO    -4.97 -0.459 -0.661 <tibble [1 × 5…
# 10 Repeat1 Fold1 AD        MeanBV logTOPY…   -4.97 -0.459 -0.661 <tibble [1 × 5…
# # … with 41,672 more rows, and 1 more variable: AccuracyEst <dbl>

```

## fix bug in meanPredAccuracy
Ooops... meanPredAccuracy screwed up because of the 3 traits NOT on the sel. index...

```{r}
outName<-"output/cvAD_5rep5fold"
crossValOut<-readRDS(file=paste0(outName,"_predMeans.rds"))
snpeffs<-readRDS(file=paste0(outName,"_markerEffects.rds"))
modelType="AD"
selInd=TRUE
#crossValOut<-readRDS(file=paste0(outName,"_predVars.rds"))

```

```{r bug fixed func to add to parentWiseCrossVal.R}
...
saveRDS(out,file=paste0(outName,"_meanPredAccuracy.rds"))
